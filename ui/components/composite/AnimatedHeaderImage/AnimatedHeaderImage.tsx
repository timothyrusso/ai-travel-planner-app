...
import { HeaderIcons } from '@/ui/pages/TripDetailPage/components/HeaderIcons/HeaderIcons';
...
const AnimatedHeaderImage: FC<AnimatedHeaderImageProps> = ({ value, imageUrl }) => {
