...
- [2026-08-22] react-native-web 0.21's `View` only forwards flat `accessibilityValueMin/Max/Now/Text`
  props to ARIA `aria-value*` attributes — passing RN's native object form
