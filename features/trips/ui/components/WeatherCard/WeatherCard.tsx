    ...
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        <View style={styles.subtitleContainer}>
          <CustomIcon name={icons.cloud} size={spacing.Triple} color={colors.cyan700} />
        ...
        <View style={styles.temperatureContainer}>
          <View style={styles.columnContainer}>
            <View style={styles.subtitleContainer}>
              <CustomIcon name={icons.thermometer} size={spacing.Triple} color={colors.red500} />
          ...
          <View style={styles.columnContainer}>
            <View style={styles.subtitleContainer}>
              <CustomIcon name={icons.thermometer} size={spacing.Triple} color={colors.cyan700} />
        ...
        <View style={styles.subtitleContainer}>
          <CustomIcon name={icons.clock} size={spacing.Triple} color={colors.lime700} />
        ...
        <View style={styles.subtitleContainer}>
          <CustomIcon name={icons.shirt} size={spacing.Triple} color={colors.purple500} />
        ...
        <View style={styles.subtitleContainer}>
          <CustomIcon name={icons.sun} size={spacing.Triple} color={colors.lime700} />
        ...
        <View style={styles.subtitleContainer}>
          <CustomIcon name={icons.umbrella} size={spacing.Triple} color={colors.cyan700} />
